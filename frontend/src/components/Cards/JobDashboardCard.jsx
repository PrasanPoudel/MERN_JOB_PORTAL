...
const JobDashboardCard = ({ job }) => {
  ...
  return (
    <div className="flex flex-col items-start justify-between p-2 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          <h4 className="font-semibold text-xs sm:text-base max-w-fit text-gray-900 truncate">
