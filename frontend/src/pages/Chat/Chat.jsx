      ...
      <div className="h-[calc(100vh-5rem)] flex bg-linear-to-br from-gray-50 via-gray-50 to-gray-100">
                            ...
                            <span
                              className={`inline-flex items-center p-2 rounded-full text-xs font-medium border ${
                                conv.user.role === "employer"
                                  ? "bg-orange-100 text-orange-600 border-orange-400 shadow-sm"
                                  : "bg-sky-100 text-sky-600 border-sky-400 shadow-sm"
                              }`}
                            >
                              {conv.user.role === "employer" ? (
        ...
        {selectedConversation ? (
          <div className="flex-1 flex flex-col min-w-0 px-1">
            {/* Chat Header */}
            <div className="bg-white p-1 bg-linear-to-r shadow-sm z-10">
              <div className="flex items-center gap-2">
                {isMobile && (
                  <button
