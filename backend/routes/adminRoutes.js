...
router.put("/jobs/:id/mark-safe", protect, adminController.markJobAsSafe);
...
router.get(
  ...
  protect,
  adminController.getAdminConversations,
);
router.get(
  "/messages/conversation/:userId",
  protect,
  adminController.getAdminConversation,
);
...
router.put(
  "/companies/:id/remove-verification",
  protect,
  adminController.removeCompanyVerification,
);
